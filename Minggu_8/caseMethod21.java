...
public class caseMethod21 {
    public static void main(String[] args) {
        ...
        double nilaiAkhir1 = 0, nilaiAkhir2 = 0, nilaiKehadiran1=0, nilaiEtika1=0, nilaiKehadiran2=0, nilaiEtika2=0;
        ...
        // nilai kehadiran 1 dan etika 1
        System.out.println("--------- Nilai Kehandiran Matkul 1 -------");
        System.out.print("Masukkan nilai kehadiran: ");
        nilaiKehadiran1 = input.nextDouble();

        System.out.println("--------- Nilai Etika Matkul 1  ----------");
        System.out.print("Masukkan Nilai Etika anda: ");
        nilaiEtika1 = input.nextDouble();
        
        
        //nilai kehadiran 2 dan etika 2
        System.out.println("--------- Nilai Kehandiran Matkul 2 -------");
        System.out.print("Masukkan nilai kehadiran: ");
        nilaiKehadiran2 = input.nextDouble();
     

        System.out.println("============ Nilai Etika Matkul 2 ============");
        System.out.print("Masukkan Nilai Etika anda: ");
        nilaiEtika2 = input.nextDouble();
        ...
        if (nilaiAkhir1 >= 60  && nilaiKehadiran1 >= 75 && nilaiEtika1 >= 70) {
            kelulusanMatkul1 = true;
            statusKelulusan1 = "Lulus";
        }
        if (nilaiAkhir2 >= 60 && nilaiKehadiran2 >= 75 && nilaiEtika2 >= 70) {
